...
@Component({
  selector: 'app-interfaz-user-b',
  templateUrl: './interfaz-user-b.page.html',
  styleUrls: ['./interfaz-user-b.page.scss'],
})
export class InterfazUserBPage implements OnInit {
  ...
  mostrarCard28: boolean = false;
  mostrarCard29: boolean = false;
  mostrarCard30: boolean = false;
  mostrarCard31: boolean = false;
  mostrarCard32: boolean = false;
  mostrarCard33: boolean = false;
  mostrarCard34: boolean = false;
  mostrarCard35: boolean = false;
  mostrarCard36: boolean = false;
  ...
  toggleCard28(){
    this.mostrarCard28 = !this.mostrarCard28;
    this.ocultarBoton = !this.ocultarBoton;
  }

  toggleCard29(){
    this.mostrarCard29 = !this.mostrarCard29;
    this.ocultarBoton = !this.ocultarBoton;
  }

  toggleCard30(){
    this.mostrarCard30 = !this.mostrarCard30;
    this.ocultarBoton = !this.ocultarBoton;
  }

  toggleCard31(){
    this.mostrarCard31 = !this.mostrarCard31;
    this.ocultarBoton = !this.ocultarBoton;
  }

  toggleCard32(){
    this.mostrarCard32 = !this.mostrarCard32;
    this.ocultarBoton = !this.ocultarBoton;
  }

  toggleCard33(){
    this.mostrarCard33 = !this.mostrarCard33;
    this.ocultarBoton = !this.ocultarBoton;
  }

  toggleCard34(){
    this.mostrarCard34 = !this.mostrarCard34;
    this.ocultarBoton = !this.ocultarBoton;
  }

  toggleCard35(){
    this.mostrarCard35 = !this.mostrarCard35;
    this.ocultarBoton = !this.ocultarBoton;
  }
  toggleCard36(){
    this.mostrarCard36 = !this.mostrarCard36;
    this.ocultarBoton = !this.ocultarBoton;
  }
